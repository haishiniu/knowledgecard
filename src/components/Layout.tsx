      ...
      <div className="p-3 bg-primary-50 border-b border-primary-100 top-0 sticky">
        <div className="mx-auto max-w-5xl relative z-20 flex justify-between items-center">
          <div className="flex items-center max-w-full">
            ...
            <Link href="/">
              <div className="ml-3 block no-underline text-xl lg:text-3xl font-extrabold leading-none lg:leading-tight">
                {config.author}
              </div>
            </Link>
          </div>
          <div className="tracking-wide text-xs spaced-x-6">
            <Link href="/blog">
              <div className=" font-semibold no-underline hover:text-primary-500">
                全部文章
              </div>
            </Link>
          </div>
